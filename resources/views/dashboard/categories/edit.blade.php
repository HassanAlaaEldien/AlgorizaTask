            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="add_category_form"
                          ...
                          action="{{ route('dashboard.categories.update', $category) }}" data-reload="1" method="POST">
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="fv-row form-group">
                                ...
                                <select class="form-control" id="parent_category" name="parent_category_id"
                                        data-list-url="{{ route('dashboard.common.list.categories',['except' => $category->id]) }}">
                                    @if($category->parent_category_id)
                                        <option value="{{ $category->parent_category_id }}" selected>
