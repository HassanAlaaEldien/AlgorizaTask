...
var KTAccountSettingsProfileDetails = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_add_company_type_form");
            e = document.querySelector("#kt_add_company_type_submit");
            ...
            e.addEventListener("click", (function (n) {
                ...
                i.validate().then((function (i) {
                    if ("Valid" === i) {
                        ...
                        var form = document.getElementById('kt_add_company_type_form');
                        ...
                        $('#kt_add_company_type_form').serializeArray().map(function (v) {
